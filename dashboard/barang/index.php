                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>List Barang</h4>
                            <a href="<?= $base_url ?>dashboard/barang/tambah.php" class="btn btn-primary">Tambah Data</a>
                        </div>
                        <form method="POST">
                            <div class="card-body table-responsive">
                                <table class="table table-striped border">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql_barang =  "SELECT barang.id as id,barang.nama as nama, kategori.nama as kategori, stok, keterangan, barang.status FROM barang JOIN kategori on kategori.id = barang.id_kategori";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($_SESSION['access'] == 1) : ?>
                                                        <a href="<?= $base_url ?>dashboard/barang/edit_barang.php?id=<?= $row['id']; ?>" class="btn btn-success btn-sm">UBAH</a>
                                                        <?php if ($row['status'] == 1) : ?>
                                                            <a href="<?= $base_url ?>dashboard/barang/hapus_barang.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm">NON-AKTIF</a>
                                                        <?php elseif ($row['status'] == 0) : ?>
                                                            <a href="<?= $base_url ?>dashboard/barang/aktif_barang.php?id=<?= $row['id']; ?>" class="btn btn-info btn-sm">AKTIF</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                            ...
                            <div class="card-footer">
                                <button type="submit" name="download" class="btn btn-primary">Cetak laporan Stok</button>
                            </div>
                        </form>
                    </div>
                </div>
